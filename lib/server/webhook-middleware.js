...
const extractBodyBuffer = (req) => {
  ...
  // Express 4 initialized an unparsed body as {}, while Express 5 leaves it
  // undefined. Keep the webhook forwarding contract stable for bodyless GET
  // hooks that AlphaClaw converts to POST requests.
