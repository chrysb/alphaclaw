...
const kSetupWatchdogTerminalWsPath = "/setup-api/watchdog/terminal/ws";
const kChatWsPath = "/api/ws/chat";
const kSetupChatWsPath = "/setup-api/ws/chat";
...
const createWatchdogTerminalWsBridge = ({
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    if (
      ...
      requestUrl.pathname === kSetupWatchdogTerminalWsPath ||
      requestUrl.pathname === kChatWsPath ||
      requestUrl.pathname === kSetupChatWsPath
    ) {
      const upgradeReq = {
        headers: req.headers,
    ...
    if (requestUrl.pathname === kChatWsPath || requestUrl.pathname === kSetupChatWsPath) {
