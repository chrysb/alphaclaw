...
// Render the topic registry as a markdown section for managed bootstrap guidance.
const renderTopicRegistryMarkdown = ({
  ...
  if (includeSyncGuidance) {
    lines.push(
      ...
      "- Never edit the managed topic registry section in `hooks/bootstrap/AGENTS.md` directly",
      "",
    );
  } else {
    lines.push("");
