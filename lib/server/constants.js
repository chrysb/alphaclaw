...
const { createClawRuntime } = require("./claw-runtime");
...
const kClawRuntime = createClawRuntime({ rootDir: kRootDir });

const PORT = parseInt(process.env.PORT || "3000", 10);
const kDefaultGatewayPort = kClawRuntime.defaultGatewayPort;
const GATEWAY_HOST = "127.0.0.1";
const kDefaultGatewayUrl = `http://${GATEWAY_HOST}:${kDefaultGatewayPort}`;
const OPENCLAW_DIR = kClawRuntime.stateDir;
const GATEWAY_TOKEN = process.env.OPENCLAW_GATEWAY_TOKEN || "";
const ENV_FILE_PATH = path.join(kRootDir, ".env");
const WORKSPACE_DIR = kClawRuntime.workspaceDir;
...
const kSystemVars = new Set([
  ...
  "ALPHACLAW_CLAW_RUNTIME",
  "ALPHACLAW_OPENCLAW_RUNTIME",
  "ALPHACLAW_GATEWAY_PORT",
  "DENCHCLAW_WEB_PORT",
  "DENCHCLAW_DAEMONLESS",
